// Transport layer (SCOPING.md §8.1, "transport"): the fish<->homelab contract. Mirrors the
...
// Stubs today; the real impl adds WiFi + esp_http_client once the board is on the bench.
#pragma once
